...
function Notifications() {
  ...
  return (
    <div>
      <UserNavbar />
      <div className="user-shell user-notifications-shell">
        <UserSidebar unreadCount={unreadCount} />
        <main className="user-content user-notifications-page">
          {/* Page header */}
          <div
          ...
          {/* Notifications list */}
          {!loading && !error && (
            <div className="data-table-card user-notifications-card">
              <div className="user-notifications-items">
                {notifs.length === 0 ? (
              ...
              {notifs.length > NOTIFS_PER_PAGE && (
                <div
                  className="user-notifications-pagination"
                  style={{
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "space-between",
