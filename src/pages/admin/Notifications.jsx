...
function Notifications() {
  ...
  return (
    <div>
      <AdminNavbar />
      <div className="admin-shell admin-notifications-shell">
        <AdminSidebar unreadCount={unreadCount} />
        <main className="admin-content admin-notifications-page">
          {/* Page header */}
          <div
          ...
          {/* Notifications list */}
          {!loading && !error && (
            <div className="data-table-card admin-notifications-card">
