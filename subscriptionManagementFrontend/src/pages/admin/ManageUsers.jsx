...
function ManageUsers() {
  ...
  return (
    <div>
      <AdminNavbar />
      <div className="admin-shell manage-users-shell">
        <AdminSidebar />
        {/* ✅ Reduced padding: was 32px, now 16px 28px */}
        <main className="admin-content manage-users-page" style={{ padding: '16px 28px' }}>

          {/* ✅ Single compact header row: title + stat pills + search + filter */}
          <div className="manage-users-toolbar" style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '12px', flexWrap: 'wrap' }}>
          ...
          {/* Table */}
          <div className="data-table-card manage-users-table-card">
            ...
            {loading ? (
              ...
              <>
                ...
                {/* Pagination bar */}
                {totalPages > 1 && (
                  <div className="manage-users-pagination" style={{
