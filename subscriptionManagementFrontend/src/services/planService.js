...
export const createPlanAPI = async (planData) => {
  const response = await api.post('/api/plan', planData)
...
export const getAllPlansAPI = async () => {
  const response = await api.get('/api/plan/allplans')
  return response.data
}
// ── GET PLAN BY NAME ──────────────────────────────────────────
...
export const getPlanByNameAPI = async (name) => {
  const response = await api.get(`/api/plan/planbyname/${encodeURIComponent(name)}`)
  return response.data
}
...
export const updatePlanAPI = async (planData) => {
  const response = await api.put('/api/plan', planData)
  return response.data
}
...
export const getPlansByStatusAPI = async (status) => {
  const response = await api.get(`/api/plan/allplansbystatus/${status}`)
  return response.data
}

export const getPlansForUserByServiceTypeAPI = async (serviceType) => {
  const response = await api.get(`/api/plan/allplansforuser/${encodeURIComponent(serviceType)}`)
  return response.data
}